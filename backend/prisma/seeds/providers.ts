...
export async function seedProviders(ctx: SeedContext) {
  ...
  const providers = [
    ...
    {
      id: SEED_IDS.providers.tuition,
      userId: SEED_IDS.users.tuition,
      displayName: 'Island Tuition Academy',
      businessName: 'Island Tuition Academy',
      description: 'Primary and secondary subject tuition in Malé.',
      contactEmail: 'tuition@seed.maldives.local',
